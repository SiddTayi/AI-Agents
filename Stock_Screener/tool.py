...
def simple_screener(screen_type: str, offset: int) -> str:
    ...
    Args:
        screen_type: One of a default set of stock screener queries from yahoo
    ...
    fields = ["shortName", "bid", "ask", "exchange", "fiftyTwoWeekHigh", 
              "fiftyTwoWeekLow", "averageAnalystRating", "dividentYield", "symbol"
              ]
    output_data = []
